...
export default function Plans() {
    ...
    const handlePayment = async (total, email) => {
        ...
        if(total == 0){
            return toast.error("Already enrolled in this plan");
        }
    ...
    return (
        <div className="dark:bg-slate-800 dark:text-white flex w-[100%] justify-between items-center pl-10 pr-10 pb-[56px] align-middle pt-10">
