...
export default function Profile() {
    ...
    return (
        <div  className={`pt-2  w-[100] h-[93vh] flex justify-center dark:bg-slate-800 dark:text-slate-400`}>
            <div className="text-center">

                <div >
                    <div className="px-4 py-5 sm:px-6 flex items-center">
                        <img src={credentials.profile.picture ? credentials.profile.picture : "/photo.png"} alt="wdw" width='80px' className="rounded-full ml-28" />
                    </div>
