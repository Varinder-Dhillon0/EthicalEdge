    ...
    <div className="relative mt-16 bg-violet-600">
      ...
      <div className="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="grid lg:grid-cols-5">
          ...
          <div className="grid w-full grid-cols-2 gap-10 row-gap-8 lg:col-span-3 md:grid-cols-3 justify-items-start  mb-10">
            <div>
        ...
        <div className="flex flex-col justify-between pt-5 pb-10 border-t-2 border-[#43f9e0] sm:flex-row">
          <p className="text-sm text-gray-100">
            © Copyright 2023 LegalFirm. All rights reserved.
          </p>
          <div className="flex items-center mt-4 space-x-4 sm:mt-0">
            ...
            >
              <svg viewBox="0 0 24 24" fill="#fff" className="h-[27px]">
            ...
            <a
              ...
              className="transition-colors duration-300 text-deep-purple-100 hover:text-teal-accent-400"
            >
              <svg viewBox="0 0 30 30" fill="#fff" className="h-7">
