import { udayanlawyer, rehanlawyer, varinderlawyer, anshullawyer } from "../../assets";

export default function Team(){
    return (
        <div id="Lawyers" className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
            <div>
              <p className="inline-block px-3 py-px mb-4 text-xs font-semibold tracking-wider text-violet-600 uppercase rounded-full">
                Core Team
              </p>
            </div>
