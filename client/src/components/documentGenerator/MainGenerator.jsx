...
export default function MainGenerator() {
  ...
  return (
    <div className={`pt-4 justify-center h-[100] dark:bg-slate-800 dark:text-slate-400`}>
      <h2 className='text-center text-2xl font-bold text-violet-600 mt-3'>Select from the below options the document you want to generate!</h2>
