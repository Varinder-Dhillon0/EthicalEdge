...
export default function Bp() {
  ...
  // Trigger the browser to download the PDF document
    ...
    return (
      <div className={`dark:bg-slate-800 dark:text-white  w-full p-8 bg-white rounded-lg shadow-md flex flex-col items-center`}>
        ...
        <div className="form flex flex-col border-b-2 border-purple-500">
          ...
          <input id="effectiveDate" type="date" class="w-full focus:outline-none  text-gray-900 text-sm focus:ring-0 focus  p-2.5 dark:bg-[#0f151e] dark:placeholder-gray-400 dark:text-white animated-border "/>
          <h4 class="text-lg font-bold mb-2">Partners details</h4>
          <input id="partner1Name" type="text" placeholder="Partner-1 Name" class="w-full focus:outline-none  text-gray-900 text-sm focus:ring-0 focus  p-2.5 dark:bg-[#0f151e] dark:placeholder-gray-400 dark:text-white animated-border" />
          <input id="partner1Address" type="text" placeholder="Partner-1 Address" class="w-full focus:outline-none  text-gray-900 text-sm focus:ring-0 focus  p-2.5 dark:bg-[#0f151e] dark:placeholder-gray-400 dark:text-white animated-border" />
          <h4 class="text-lg font-bold mb-2">Employer details</h4>
          <input id="partner2Name" type="text" placeholder="Partner-2 Name" class="w-full focus:outline-none  text-gray-900 text-sm focus:ring-0 focus  p-2.5 dark:bg-[#0f151e] dark:placeholder-gray-400 dark:text-white animated-border" />
          <input id="partner2Address" type="text" placeholder="Partner-2 Address" class="w-full focus:outline-none  text-gray-900 text-sm focus:ring-0 focus  p-2.5 dark:bg-[#0f151e] dark:placeholder-gray-400 dark:text-white animated-border" />
          <h4 class="text-lg font-bold mb-2">PURPOSE OF PARTNERSHIP</h4>
          <input id="purpose-1" type="text" placeholder="Purpose-1" class="w-full focus:outline-none  text-gray-900 text-sm focus:ring-0 focus  p-2.5 dark:bg-[#0f151e] dark:placeholder-gray-400 dark:text-white animated-border" />
          <input id="purpose-2" type="text" placeholder="purpose-2" class="w-full focus:outline-none  text-gray-900 text-sm focus:ring-0 focus  p-2.5 dark:bg-[#0f151e] dark:placeholder-gray-400 dark:text-white animated-border" />
          <input id="purpose-3" type="text" placeholder="purpose-3" class="w-full focus:outline-none  text-gray-900 text-sm focus:ring-0 focus  p-2.5 dark:bg-[#0f151e] dark:placeholder-gray-400 dark:text-white animated-border" />
          <input id="purpose-4" type="text" placeholder="purpose-4" class="w-full focus:outline-none  text-gray-900 text-sm focus:ring-0 focus  p-2.5 dark:bg-[#0f151e] dark:placeholder-gray-400 dark:text-white animated-border" />
          <input id="purpose-5" type="text" placeholder="purpose-5" class="w-full focus:outline-none  text-gray-900 text-sm focus:ring-0 focus  p-2.5 dark:bg-[#0f151e] dark:placeholder-gray-400 dark:text-white animated-border" />
